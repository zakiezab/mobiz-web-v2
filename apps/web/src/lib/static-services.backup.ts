// BACKUP: Static service data for services that are not yet in Sanity CMS
// This file contains the backup of dummy/static service content
// To restore, copy the STATIC_SERVICES object from this file back to static-services.ts
...
// BACKUP: Azure Landing Zone static service data
export const STATIC_SERVICES_BACKUP: Record<string, StaticService> = {
  "azure-landing-zone": {
